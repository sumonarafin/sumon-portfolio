    ...
    <section id="education" className="py-24 px-6 relative z-10 max-w-5xl mx-auto">
      <ScrollReveal direction="zoom" className="text-center mb-16">
        <h2 className="text-3xl sm:text-5xl font-bold font-['Space_Grotesk'] text-white">
          Education & <span className="bg-clip-text text-transparent bg-gradient-to-r from-accent3 to-accent1">Learning</span>
        </h2>
      ...
      <div className="grid grid-cols-1 gap-8">
        {educations.map((edu, idx) => (
          ...
          >
            <div className="p-4 bg-gradient-to-br from-accent3 to-accent1 rounded-2xl text-white shadow-lg">
            ...
            <div className="space-y-2 flex-1">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-2">
                ...
                <span className="text-xs px-3 py-1 rounded-full bg-accent1/20 text-accent1 border border-accent1/30 w-fit">
                  {edu.period}
                </span>
              </div>
              <p className="text-accent1 font-medium">{edu.institution}</p>
