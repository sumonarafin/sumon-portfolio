    ...
    <section id="certifications" className="py-24 px-6 relative z-10 max-w-7xl mx-auto">
      <ScrollReveal direction="zoom" className="text-center mb-16">
        <h2 className="text-3xl sm:text-5xl font-bold font-['Space_Grotesk'] text-white">
          Certifications &amp; <span className="bg-clip-text text-transparent bg-gradient-to-r from-accent1 to-accent3">Languages</span>
        </h2>
        <div className="w-24 h-1 bg-gradient-to-r from-accent1 to-accent3 mx-auto mt-4 rounded-full" />
      </ScrollReveal>
          ...
          return (
            ...
            >
              ...
              <div className="space-y-4">
                {card.items.map((item) => (
                  <div key={item.name} className="border-l-2 border-accent1/30 pl-4">
